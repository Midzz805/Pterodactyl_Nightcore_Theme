...
installTheme(){
    ...
    git clone https://github.com/Midzz805/Pterodactyl_Nightcore_Theme.git > /dev/null 2>&1
...
repair(){
    bash <(curl https://raw.githubusercontent.com/Midzz805/Pterodactyl_Nightcore_Theme/main/repair.sh)
}
...
echo "Copyright (c) 2024 Angelillo15 and Cingz"
